...
function goOccasion(occasion){
window.location.href = "shop.html?occasion=" + occasion;
}
...
// FILTER OCCASION
if(selectedOccasion){
    filteredData = filteredData.filter(p => p.occasion === selectedOccasion);
}
